...
(function(win){
	...
	function clone(src, out) {
		for (let attr in src.prototype) out.prototype[attr] = src.prototype[attr]
	}

	function rect() {
		this.item = document.createElement('div')
		this.item.className = 'rectangle'
	}

	// Takes the attributes from circle and copies it to rectangle
	clone(circle, rect)
